...
echo -e "\e[0;92$app I3 setup script starting...\e[0m"
# Updating
...
# == installing packages == #
# Manjaro
sudo pacman -S $(cat src/distros/i3/distro-pkg/manjaro) --noconfirm
# Solus
sudo eopkg install $(cat src/distros/i3/distro-pkg/solus) -y 
#Fedora
sudo dnf install $(cat src/distros/i3/distro-pkg/fedora) -y --allowerasing --skip-broken
# Ubuntu
sudo apt-get install $(cat src/distros/i3/distro-pkg/ubuntu) -y 
